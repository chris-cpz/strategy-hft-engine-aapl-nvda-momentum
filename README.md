...
# HFT Engine - AAPL NVDA Momentum

> *Generated with [CPZAI](https://ai.cpz-lab.com/)*

A momentum trading strategy built on CPZAI Platform.

## Strategy Overview

**Type:** Momentum

Quantitative trading strategy with signal generation and risk management.

## Quick Start

```bash
# Clone repository
git clone https://github.com/chris-cpz/strategy-hft-engine-aapl-nvda-momentum.git
cd strategy-hft-engine-aapl-nvda-momentum
